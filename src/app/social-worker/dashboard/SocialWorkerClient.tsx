    ...
    <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
      <div className="overflow-hidden rounded-xl2 bg-gradient-to-br from-sky to-sky-deep px-6 py-7 text-white shadow-pop sm:px-8">
        ...
        <p className="mt-1 max-w-xl text-sm text-white/85">
          Manage the class rep, review attendance on a real calendar, and message your rep about
          any absence or excuse directly from the day it happened.
        </p>
        {alertCount > 0 && (
      ...
      <div className="mt-5 rounded-xl2 border border-ink/10 bg-white p-4 shadow-card sm:p-5">
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs text-ink/50">
              {currentRep ? (
                ...
                "No class rep assigned yet — pick one below."
              )}
            </p>
          </div>
          <input
        ...
        <div className="mt-3 flex max-h-40 flex-wrap gap-2 overflow-y-auto">
          {loading ? (
            ...
            <p className="text-sm text-ink/40">No students match “{repQuery}”.</p>
          ) : (
